        ...
        <div class="row justify-content-center">
            ...
            <div class="col-8">
                <div class="d-flex my-3 justify-content-between align-items-baseline">
                    ...
                    <a href="{{ route('centers.create') }}" class="btn btn-primary shadow">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-baseline gap-2">
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#modal-{{ $center->id }}">
                                            <i class="bi bi-trash"></i>
                                            Eliminar
                                        </button>

                                        {{-- Modal for delet --}}
                                        <div class="modal fade" id="modal-{{ $center->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Estás seguro de eliminar a <b>{{ $center->name }}</b> de forma
                                                        permanente?
                                                    </div>
